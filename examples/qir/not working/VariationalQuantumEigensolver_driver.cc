...
extern "C" double
Microsoft__Quantum__Samples__Chemistry__SimpleVQE__GetEnergyHydrogenVQE__Interop(
    double, double, double, long);
extern "C" Microsoft::Quantum::IRuntimeDriver* GetDMSim();
extern "C" void
Microsoft__Quantum__Samples__Chemistry__SimpleVQE__GetEnergyHydrogenVQE(double,
                                                                        double,
                                                                        double,
                                                                        long);
...
int main(int argc, char* argv[]) {
  ...
  Microsoft__Quantum__Samples__Chemistry__SimpleVQE__GetEnergyHydrogenVQE(

...
- ✨ Add passes for quantum-specific interprocedural optimization, together with
  the call-aware wire and tensor iteration they build on ([#2193], [#2194],
  [#2196], [#2197], [#2198], [#2199], [#2200], [#2201]) ([**@DRovara**],
  [**@burgholzer**])

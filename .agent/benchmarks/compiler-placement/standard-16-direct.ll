module {
  llvm.mlir.global private constant @__constant_16xf64(dense<[2.3561944901923448, 4.7123889803846897, 3.1415926535897931, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00, 0.000000e+00]> : tensor<16xf64>) {addr_space = 0 : i32, alignment = 64 : i64} : !llvm.array<16 x f64>
  ...
  llvm.func @main() -> i64 attributes {passthrough = ["entry_point", ["output_labeling_schema", "labeled"], ["qir_profiles", "adaptive_profile"], ["required_num_qubits", "0"], ["required_num_results", "0"]]} {
    ...
    %2 = llvm.mlir.constant(15 : index) : i64
    %3 = llvm.mlir.constant(0 : index) : i64
    %4 = llvm.mlir.addressof @__constant_16xf64 : !llvm.ptr
    ...
    %11 = llvm.getelementptr %4[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<16 x f64>

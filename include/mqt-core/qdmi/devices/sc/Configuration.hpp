...
[[nodiscard]] qdmi::Result<Device> readJSON(std::string_view json,
                                            std::string_view source);
[[nodiscard]] qdmi::Result<Device> readJSON(std::istream& stream,
                                            std::string_view source = "input");
[[nodiscard]] qdmi::Result<Device> readJSON(const std::string& path);

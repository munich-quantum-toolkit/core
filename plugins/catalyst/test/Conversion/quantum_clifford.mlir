...
module {
  // CHECK-LABEL: func @testCatalystQuantumToMQTOptClifford()
  func.func @testCatalystQuantumToMQTOptClifford() {
    ...
    // CHECK: %out_qubits = mqtopt.i( static [] mask []) %out_qubit : !mqtopt.Qubit
    // CHECK: %out_qubits_{{.*}} = mqtopt.h( static [] mask []) %out_qubits : !mqtopt.Qubit
    // CHECK: %out_qubits_{{.*}} = mqtopt.s( static [] mask []) %out_qubits_{{.*}} : !mqtopt.Qubit
    // CHECK: %out_qubits_{{.*}} = mqtopt.s( static [] mask []) %out_qubits_{{.*}} : !mqtopt.Qubit
    // CHECK: %out_qubits_{{.*}} = mqtopt.t( static [] mask []) %out_qubits_{{.*}} : !mqtopt.Qubit
    // CHECK: %out_qubits_{{.*}} = mqtopt.t( static [] mask []) %out_qubits_{{.*}} : !mqtopt.Qubit
    // CHECK: %out_qubits_{{.*}}, %pos_ctrl_out_qubits{{.*}} = mqtopt.s( static [] mask []) %out_qubit_{{.*}} ctrl %out_qubits_{{.*}} : !mqtopt.Qubit ctrl !mqtopt.Qubit
    // CHECK: %out_qubits_{{.*}}, %pos_ctrl_out_qubits_{{.*}} = mqtopt.t( static [] mask []) %out_qubits_{{.*}} ctrl %pos_ctrl_out_qubits{{.*}} : !mqtopt.Qubit ctrl !mqtopt.Qubit
    ...
    %q0_i = quantum.custom "Identity"() %q0 : !quantum.bit
    %q0_h = quantum.custom "Hadamard"() %q0_i : !quantum.bit
    %q0_s = quantum.custom "S"() %q0_h : !quantum.bit
    ...
    %q1_out, %q0_out = quantum.custom "S"() %q1 ctrls(%q0_tdg) ctrlvals(%true) : !quantum.bit ctrls !quantum.bit
    %q1_out2, %q0_out2 = quantum.custom "T"() %q1_out ctrls(%q0_out) ctrlvals(%true) : !quantum.bit ctrls !quantum.bit

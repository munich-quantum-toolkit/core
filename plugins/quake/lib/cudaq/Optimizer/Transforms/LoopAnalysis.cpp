...
/// that has a second auxiliary condition to determine if a given loop
...
/// of unrolling if the auxiliary condition can be computed as a constant. It is
...
template <typename T> constexpr int computeArgsOffset() {

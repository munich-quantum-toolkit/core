...
#include "mlir/Builder/Intrinsics.h"
#include "mlir/Builder/Runtime.h"
#include "mlir/CodeGen/QIRFunctionNames.h"
#include "mlir/CodeGen/QIROpaqueStructTypes.h"
...
template <bool isOutput> static Type genBufferType(Type ty) {

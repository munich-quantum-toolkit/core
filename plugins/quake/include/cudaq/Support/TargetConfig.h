...
template <> struct ScalarBitSetTraits<cudaq::config::TargetFeatureFlag> {
  static void bitset(IO& io, cudaq::config::TargetFeatureFlag& value);
};

template <> struct ScalarEnumerationTraits<cudaq::config::ArgumentType> {
  static void enumeration(IO& io, cudaq::config::ArgumentType& value);
};

template <> struct MappingTraits<cudaq::config::TargetArgument> {
  static void mapping(IO& io, cudaq::config::TargetArgument& info);
};

template <> struct BlockScalarTraits<cudaq::config::SimulationBackendSetting> {
...
template <> struct MappingTraits<cudaq::config::ConditionalBuildConfig> {
  static void mapping(IO& io, cudaq::config::ConditionalBuildConfig& info);
};

template <> struct MappingTraits<cudaq::config::BackendEndConfigEntry> {
  static void mapping(IO& io, cudaq::config::BackendEndConfigEntry& info);
};
template <> struct MappingTraits<cudaq::config::BackendFeatureMap> {
  static void mapping(IO& io, cudaq::config::BackendFeatureMap& info);
};

template <> struct MappingTraits<cudaq::config::TargetConfig> {

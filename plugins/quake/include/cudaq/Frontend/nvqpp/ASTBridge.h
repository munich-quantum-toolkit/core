...
public:
  ...
  template <bool postCondition, typename S> bool traverseDoOrWhileStmt(S* x);
  ...
  template <typename D> bool traverseAnyRecordDecl(D* x);
...
private:
  ...
  template <typename A> mlir::Location toLocation(const A* x) {

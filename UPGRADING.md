...
<<<<<<< HEAD
||||||| parent of e78c99a2 (✨ Add support for QDMI child devices to the driver and FoMaC libraries (#1897))
...
>>>>>>> e78c99a2 (✨ Add support for QDMI child devices to the driver and FoMaC libraries (#1897))
## [3.7.0]

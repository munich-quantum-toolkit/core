...
Result* __quantum__rt__result_get_zero() {
  ...
  return reinterpret_cast<Result*>(qir::QIR_DD_Backend::RESULT_ZERO_ADDRESS);
}

Result* __quantum__rt__result_get_one() {
  // NOLINTNEXTLINE(performance-no-int-to-ptr)
  return reinterpret_cast<Result*>(qir::QIR_DD_Backend::RESULT_ONE_ADDRESS);
}

bool __quantum__rt__result_equal(Result* result1, Result* result2) {
  auto& backend = qir::QIR_DD_Backend::getInstance();
...
void __quantum__rt__result_update_reference_count(Result* result,
  ...
  if (result != nullptr &&
      result !=
          reinterpret_cast<Result*>(qir::QIR_DD_Backend::RESULT_ZERO_ADDRESS) &&
      result !=
          reinterpret_cast<Result*>(qir::QIR_DD_Backend::RESULT_ONE_ADDRESS)) {
...
void __quantum__rt__initialize(char* /*unused*/) {
  qir::QIR_DD_Backend::getInstance().resetBackend();
}

...
# Release wheels use full LTO with the compiler that builds their native code.
if(SKBUILD AND DEPLOY)
  foreach(lang C CXX)
    list(TRANSFORM CMAKE_${lang}_COMPILE_OPTIONS_IPO REPLACE "^-flto=thin$" "-flto=full")
  endforeach()
endif()

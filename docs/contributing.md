...
- 🐛 Report bugs:
  ...
  <https://github.com/munich-quantum-toolkit/core/issues>.
...
which contains context and instructions to help the agent work on MQT Core.
...
MQT Core adheres to [Semantic Versioning],
...
Use it to explain how users may need to adapt their usage of MQT Core,
...
When it is time to release a new version of MQT Core,

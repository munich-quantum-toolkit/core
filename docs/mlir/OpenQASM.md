...
scalar or bit outputs when needed. Subarray access, array slices, whole-array
copies, array outputs, runtime angle conversion, and jeff or OpenQASM export of
array storage are not yet supported. Gate definitions cannot capture mutable
arrays; pass selected entries as gate parameters instead.

...
[[nodiscard]] bench::Phase phaseFromPython(const nb::object& value) {
  ...
  return ::mqt::bindings::invoke([&] {
    return bench::Phase::create(nb::cast<uint64_t>(numerator),
                                denominatorValue);
  });
}
...
void registerQPE(const nb::module_& m) {
  nb::class_<bench::Phase>(
      ...
      .def(
          ...
          [](bench::Phase* self, uint64_t numerator, uint64_t denominator) {
            new (self) bench::Phase(::mqt::bindings::invoke(
                [&] { return bench::Phase::create(numerator, denominator); }));
          },
  ...
  qpe.def(
         ...
         [](bench::QPE* self, bench::QPEOptions options) {
           new (self) bench::QPE(::mqt::bindings::invoke(
               [&] { return bench::QPE::create(options); }));
         },
         "options"_a)
      ...
      .def("probability", bindResult(&bench::QPE::probability), "outcome"_a,
           "Return the ideal probability of an outcome.")
      .def("evaluate", bindResult(&bench::QPE::evaluate), "counts"_a,
      ...
      .def_static("from_instance_specification_json",
                  bindResult(&bench::qpeFromInstanceSpecificationJSON),
                  "json"_a, nb::kw_only(),
                  "source"_a = "<instance-specification>",
                  "Parse a strict benchmark instance specification.")
      .def_static("from_manifest_json", bindResult(&bench::qpeFromManifestJSON),

...
void registerQFT(const nb::module_& m) {
  ...
  qft.def(
         ...
         [](bench::QFT* self, bench::QFTOptions options) {
           new (self) bench::QFT(::mqt::bindings::invoke(
               [&] { return bench::QFT::create(options); }));
         },
         "options"_a)
      ...
      .def("probability", bindResult(&bench::QFT::probability), "outcome"_a,
           "Return the ideal probability of an outcome.")
      .def("evaluate", bindResult(&bench::QFT::evaluate), "counts"_a,
      ...
      .def_static("from_instance_specification_json",
                  bindResult(&bench::qftFromInstanceSpecificationJSON),
                  "json"_a, nb::kw_only(),
                  "source"_a = "<instance-specification>",
                  "Parse a strict benchmark instance specification.")
      .def_static("from_manifest_json", bindResult(&bench::qftFromManifestJSON),

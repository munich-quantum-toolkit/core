  ...
  repeatUntilSuccess
      .def(
          ...
          [](bench::RepeatUntilSuccess* self,
            ...
            new (self) bench::RepeatUntilSuccess(
                takeBenchResult(bench::RepeatUntilSuccess::create(options)));
          },
      ...
      .def("probability",
           bindBenchResult(&bench::RepeatUntilSuccess::probability),
           "outcome"_a, "Return the ideal probability of an outcome.")
      .def("evaluate", bindBenchResult(&bench::RepeatUntilSuccess::evaluate),
      ...
      .def_static("from_manifest_json",
                  bindBenchResult(&bench::repeatUntilSuccessFromManifestJSON),

...
NB_MODULE(MQT_CORE_MODULE_NAME,
  ...
  sessionParameters
      .def(
          "__init__",
          [](qdmi::SessionParameters* self, std::optional<std::string> baseUrl,
            ...
            new (self) qdmi::SessionParameters{
          ...
          nb::kw_only(), "base_url"_a = nb::none(), "token"_a = nb::none(),
          "auth_file"_a = nb::none(), "auth_url"_a = nb::none(),
          "username"_a = nb::none(), "password"_a = nb::none(),
          "custom1"_a = nb::none(), "custom2"_a = nb::none(),
          "custom3"_a = nb::none(), "custom4"_a = nb::none(),
          "custom5"_a = nb::none(),
          R"pb(Create session parameters from optional keyword arguments.

Args:
    base_url: Base URL of the device service.
    token: Authentication token.
    auth_file: Path to an authentication file.
    auth_url: URL of the authentication service.
    username: Authentication username.
    password: Authentication password.
    custom1: First implementation-defined session parameter.
    custom2: Second implementation-defined session parameter.
    custom3: Third implementation-defined session parameter.
    custom4: Fourth implementation-defined session parameter.
    custom5: Fifth implementation-defined session parameter.)pb")
  ...
  definition
      .def(
          ...
          [](qdmi::DeviceDefinition* self, std::string deviceId,
             std::filesystem::path library, std::string prefix,
...
Args:
  ...
  auto registry = nb::class_<qdmi::DeviceRegistry>(
      m, "DeviceRegistry",
...
Returns:
  ...
  job.def_prop_ro("id", &qdmi::Job::getId,
                  R"pb(The device-assigned job identifier.)pb");
  ...
  job.def_prop_ro(
      ...
      R"pb(The exact bytes of the submitted program.)pb");
...
operations, child devices, and jobs.)pb");
  ...
  device.def("name", &qdmi::Device::getName,
             R"pb(Return the device name reported by its implementation.)pb");

  device.def(
      "version", &qdmi::Device::getVersion,
      R"pb(Return the device version reported by its implementation.)pb");
  ...
  device.def("library_version", &qdmi::Device::getLibraryVersion,
             R"pb(Return the device library version.)pb");
...
Args:
    program: Text submitted with a terminating null byte, or exact bytes.
...
Returns:
  ...
  device.def(
      ...
      "custom3"_a = nb::none(), "custom4"_a = nb::none(),
      "custom5"_a = nb::none(),
      nb::sig("def submit_job(self, program: bytes, program_format: "
              "ProgramFormat, num_shots: int, *, custom1: str | bool | int | "
              "float | None = None, custom2: str | bool | int | float | None "
              "= None, custom3: str | bool | int | float | None = None, "
              "custom4: str | bool | int | float | None = None, custom5: str "
              "| bool | int | float | None = None) -> Job"),
      nb::rv_policy::reference_internal,
      R"pb(Submit an exact byte payload to the device.)pb");
  ...
  site.def("index", &qdmi::Site::getIndex,
           R"pb(Return the device-assigned site index.)pb");
...
library.)pb");
  manager
      .def(nb::init<>(),
           R"pb(Create a manager from the standard configuration sources.)pb")
      .def(nb::init<qdmi::DeviceRegistry>(), "registry"_a,
           R"pb(Create a manager from an immutable registry snapshot.)pb")
      .def_prop_ro(
          "definitions",
          [](const qdmi::DeviceManager& self) { return self.definitions(); },
          R"pb(The manager's immutable device definitions.)pb")
      .def(
          "open",

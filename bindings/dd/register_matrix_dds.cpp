...
Returns:
  ...
  mat.def("get_entry",
          bindings::bindResult(nb::overload_cast<size_t, size_t, size_t>(
              &dd::mEdge::getValueByIndex, nb::const_)),
          "num_qubits"_a, "row"_a, "col"_a,
          "Get the entry of the matrix by row and column index.");

  mat.def("get_entry_by_path", bindings::bindResult(&dd::mEdge::getValueByPath),
          "num_qubits"_a, "decisions"_a,
          R"pb(Get the entry of the matrix by decisions.

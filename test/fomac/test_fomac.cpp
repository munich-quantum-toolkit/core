...
TEST(AuthenticationTest, SessionParameterToString) {
  EXPECT_EQ(qdmi::toString(QDMI_SESSION_PARAMETER_TOKEN), "TOKEN");
  EXPECT_EQ(qdmi::toString(QDMI_SESSION_PARAMETER_AUTHFILE), "AUTH FILE");
  EXPECT_EQ(qdmi::toString(QDMI_SESSION_PARAMETER_AUTHURL), "AUTH URL");
  EXPECT_EQ(qdmi::toString(QDMI_SESSION_PARAMETER_USERNAME), "USERNAME");
  EXPECT_EQ(qdmi::toString(QDMI_SESSION_PARAMETER_PASSWORD), "PASSWORD");
  EXPECT_EQ(qdmi::toString(QDMI_SESSION_PARAMETER_PROJECTID), "PROJECT ID");
  EXPECT_EQ(qdmi::toString(QDMI_SESSION_PARAMETER_MAX), "MAX");
  EXPECT_EQ(qdmi::toString(QDMI_SESSION_PARAMETER_CUSTOM1), "CUSTOM1");
  EXPECT_EQ(qdmi::toString(QDMI_SESSION_PARAMETER_CUSTOM2), "CUSTOM2");
  EXPECT_EQ(qdmi::toString(QDMI_SESSION_PARAMETER_CUSTOM3), "CUSTOM3");
  EXPECT_EQ(qdmi::toString(QDMI_SESSION_PARAMETER_CUSTOM4), "CUSTOM4");
  EXPECT_EQ(qdmi::toString(QDMI_SESSION_PARAMETER_CUSTOM5), "CUSTOM5");
}

...
class SessionParameters:
    ...
    def __init__(
        ...
        *,
        ...
        """Create session parameters from optional keyword arguments.
        ...
        Args:
            ...
            custom5: Fifth implementation-defined session parameter.
        """
...
class DeviceDefinition:
    ...
    def __init__(
        self, device_id: str, library: str | os.PathLike, prefix: str, *, session: SessionParameters = ...
    ) -> None:
...
class Job:
    ...
    @property
    def id(self) -> str:
        """The device-assigned job identifier."""
...
class Device:
    ...
    def name(self) -> str:
        """Return the device name reported by its implementation."""

    def version(self) -> str:
        """Return the device version reported by its implementation."""

    def status(self) -> Status:
        """Return the current QDMI device status."""

    def library_version(self) -> str:
        """Return the device library version."""
    ...
    def submit_job(
        ...
        num_shots: int,
        *,
        custom1: str | bool | int | float | None = None,  # ruff:ignore[redundant-numeric-union]
        custom2: str | bool | int | float | None = None,  # ruff:ignore[redundant-numeric-union]
        custom3: str | bool | int | float | None = None,  # ruff:ignore[redundant-numeric-union]
        custom4: str | bool | int | float | None = None,  # ruff:ignore[redundant-numeric-union]
        custom5: str | bool | int | float | None = None,  # ruff:ignore[redundant-numeric-union]
    ) -> Job:
    ...
    class Site:
        ...
        def index(self) -> int:
            """Return the device-assigned site index."""
...
class DeviceManager:
    ...
    @overload
    def __init__(self) -> None:
        """Create a manager from the standard configuration sources."""

    @overload
    def __init__(self, registry: DeviceRegistry) -> None:
        """Create a manager from an immutable registry snapshot."""

    @property
    def definitions(self) -> list[DeviceDefinition]:
        """The manager's immutable device definitions."""

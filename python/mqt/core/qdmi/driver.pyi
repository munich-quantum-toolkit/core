...
class Session:
    ...
    def __init__(
        ...
        *,
        ...
        """Create a deprecated QDMI client session with optional authentication.
    ...
    def get_devices(self) -> list[mqt.core.qdmi.Device]:

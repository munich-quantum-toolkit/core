...
class WState:
    """A validated W-state preparation benchmark."""
    ...
    @staticmethod
    def from_instance_specification_json(json: str, *, source: str = "<instance-specification>") -> WState:
        """Parse a strict benchmark instance specification."""

    @staticmethod
    def from_manifest_json(json: str, *, source: str = "<manifest>") -> WState:

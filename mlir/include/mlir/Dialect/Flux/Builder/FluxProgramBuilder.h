...
private:
  ...
  Value createOneTargetZeroParameter(const Value qubit);
  ...
  createControlledOneTargetZeroParameter(const Value control,
                                         const Value target);
  ...
  createMultiControlledOneTargetZeroParameter(const ValueRange controls,
                                              const Value target);

  /**
   * @brief Helper to create a one-target, one-parameter Flux operation
   *
   * @tparam OpType The operation type of the Flux operation
  ...
  template <typename OpType>
  Value
  createOneTargetOneParameter(const std::variant<double, Value>& parameter,
                              const Value qubit);

  /**
   * @brief Helper to create a controlled one-target, one-parameter Flux
   * operation
   *
   * @tparam OpType The operation type of the Flux operation
   * @param parameter Operation parameter
   ...
   */
  template <typename OpType>
  std::pair<Value, Value> createControlledOneTargetOneParameter(
      const std::variant<double, Value>& parameter, const Value control,
      const Value target);

  /**
   * @brief Helper to create a multi-controlled one-target, one-parameter Flux
   * operation
   *
   * @tparam OpType The operation type of the Flux operation
   * @param parameter Operation parameter
  ...
  /**
   * @brief Helper to create a one-target, three-parameter Flux operation
   *
   * @tparam OpType The operation type of the Flux operation
   * @param parameter1 Operation parameter
   * @param parameter2 Operation parameter
  ...
  /**
   * @brief Helper to create a controlled one-target, three-parameter Flux
   * operation
   *
   * @tparam OpType The operation type of the Flux operation
   * @param parameter1 Operation parameter
   ...
   */
  template <typename OpType>
  std::pair<Value, Value> createControlledOneTargetThreeParameter(
      const std::variant<double, Value>& parameter1,
      const std::variant<double, Value>& parameter2,
  ...
  /**
   * @brief Helper to create a multi-controlled one-target, three-parameter Flux
   * operation
   *
   * @tparam OpType The operation type of the Flux operation
   * @param parameter1 Operation parameter
   ...
   */
  template <typename OpType>
  std::pair<ValueRange, Value> createMultiControlledOneTargetThreeParameter(
      const std::variant<double, Value>& parameter1,
      const std::variant<double, Value>& parameter2,
  ...
  /**
   * @brief Helper to create a two-target, two-parameter Flux operation
   *
   * @tparam OpType The operation type of the Flux operation
   * @param parameter1 Operation parameter
   * @param parameter2 Operation parameter
  ...
  /**
   * @brief Helper to create a controlled two-target, two-parameter Flux
   * operation
   *
   * @tparam OpType The operation type of the Flux operation
   * @param parameter1 Operation parameter
  ...
  template <typename OpType>
  std::pair<Value, std::pair<Value, Value>>
  createControlledTwoTargetTwoParameter(
      const std::variant<double, Value>& parameter1,
      const std::variant<double, Value>& parameter2, const Value control,
      const Value qubit0, const Value qubit1);

  /**
   * @brief Helper to create a multi-controlled two-target, two-parameter Flux
   * operation
   *
   * @tparam OpType The operation type of the Flux operation
   * @param parameter1 Operation parameter
  ...
  template <typename OpType>
  std::pair<ValueRange, std::pair<Value, Value>>
  createMultiControlledTwoTargetTwoParameter(
      const std::variant<double, Value>& parameter1,
      const std::variant<double, Value>& parameter2, const ValueRange controls,
      const Value qubit0, const Value qubit1);

...
/// Returns true when IR printing is always enabled via the environment.
///
...
public:
  ...
  /// Capture the current state of @p module under the given @p header.
  ///
  ...
  /// Flush all captured entries to @c llvm::errs() if needed.
  ///

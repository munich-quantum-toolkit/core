...
module {
    ...
    llvm.func @testConvertMeasureStatic() attributes {passthrough = ["entry_point"]}  {
        // CHECK: %[[q_0:.*]] = mqtref.qubit 0
        // CHECK:  [[m_0:.*]] = mqtref.measure %[[q_0]]
...
module {
    ...
    llvm.func @testMultipleQubitRotationOp() attributes {passthrough = ["entry_point"]}  {
      ...
      ^bb1:
        ...
        llvm.call @__quantum__qis__xxminusyy__body(%q0, %q1, %c0, %c1) : (!llvm.ptr, !llvm.ptr, f64, f64) -> ()
        llvm.call @__quantum__qis__xxplusyy__body(%q0, %q1, %c0, %c1) : (!llvm.ptr, !llvm.ptr, f64, f64) -> ()
        llvm.br ^bb2
      ^bb2:
        llvm.call @__quantum__rt__qubit_release(%q0) : (!llvm.ptr) -> ()
        llvm.call @__quantum__rt__qubit_release(%q1) : (!llvm.ptr) -> ()
...
module {
    ...
    llvm.func @testMultipleQubitRotationOpStatic() attributes {passthrough = ["entry_point"]}  {
      ...
      ^bb1:
        ...
        llvm.call @__quantum__qis__xxminusyy__body(%ptr0, %ptr1, %c1, %c2) : (!llvm.ptr, !llvm.ptr, f64, f64) -> ()
        llvm.call @__quantum__qis__xxplusyy__body(%ptr0, %ptr1, %c1, %c2) : (!llvm.ptr, !llvm.ptr, f64, f64) -> ()
        llvm.br ^bb2
      ^bb2:
        llvm.br ^bb3
      ^bb3:

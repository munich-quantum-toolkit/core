...
module {
  ...
  func.func @testControlledSwapReconstruction() {
    ...
    // ========================== Check for operations that should be inserted ==============================
    // CHECK: %[[Q01_1:.*]]:4 = mqtopt.swap() %[[Q0_0]], %[[Q1_0]]
...
module {
  ...
  func.func @testControlledSwapReconstructionSimplerSurroundingCNots() {
    ...
    // ========================== Check for operations that should be inserted ==============================
    // CHECK: %[[Q0123_1:.*]]:4 = mqtopt.swap() %[[Q0_0]], %[[Q1_0]] ctrl %[[Q2_0]] negctrl %[[Q3_0]]
...
module {
  ...
  func.func @testControlledSwapReconstruction() {
    ...
    // CHECK: %[[Q0_1:.*]], %[[Q1_1:.*]], %[[Q2_1:.*]], %[[Q3_1:.*]] = mqtopt.x() %[[Q0_0]] ctrl %[[Q1_0]], %[[Q2_0]] negctrl %[[Q3_0]]
    // CHECK: %[[Q0_2:.*]], %[[Q1_2:.*]], %[[Q3_2:.*]] = mqtopt.x() %[[Q1_1]] ctrl %[[Q0_1]] negctrl %[[Q3_1]]
    // CHECK: %[[Q0_3:.*]], %[[Q1_3:.*]], %[[Q2_2:.*]], %[[Q3_3:.*]] = mqtopt.x() %[[Q0_0]] ctrl %[[Q1_0]], %[[Q2_0]] negctrl %[[Q3_0]]
    ...
    %q1_2, %q0_2, %q3_2 = mqtopt.x() %q1_1 ctrl %q0_1 negctrl %q3_1: !mqtopt.Qubit ctrl !mqtopt.Qubit negctrl !mqtopt.Qubit
    %q0_3, %q1_3, %q2_2, %q3_3 = mqtopt.x() %q0_2 ctrl %q1_2, %q2_1 negctrl %q3_2: !mqtopt.Qubit ctrl !mqtopt.Qubit, !mqtopt.Qubit negctrl !mqtopt.Qubit

...
// -----
// This test checks if a single-qubit series that is equal to the identity is fully removed.
...
// -----
// This test checks if a single-qubit series with consecutive rotations will be simplified.

module {
  // CHECK-LABEL: func.func @testMergeRotationSeries
  func.func @testMergeRotationSeries() {
    // CHECK: %[[C_0:.*]] = arith.constant 2.000000e+00
    ...
    %c_0 = arith.constant 0.500000e+00 : f64
...
// -----
// This test checks if a single-qubit series that cannot be simplified remains as-is.

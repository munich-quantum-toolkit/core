...
// RUN: quantum-opt %s -split-input-file --pass-pipeline="builtin.module(canonicalize, placement-sc{strategy=identity arch=MQTTest}, route-sc{method=naive arch=MQTTest},verify-routing-sc{arch=MQTTest})" -verify-diagnostics | FileCheck %s
// RUN: quantum-opt %s -split-input-file --pass-pipeline="builtin.module(canonicalize, placement-sc{strategy=identity arch=MQTTest}, route-sc{method=astar arch=MQTTest},verify-routing-sc{arch=MQTTest})" -verify-diagnostics | FileCheck %s
// RUN: quantum-opt %s -split-input-file --pass-pipeline="builtin.module(canonicalize, placement-sc{strategy=identity arch=IBMFalcon}, route-sc{method=naive arch=IBMFalcon},verify-routing-sc{arch=IBMFalcon})" -verify-diagnostics | FileCheck %s
// RUN: quantum-opt %s -split-input-file --pass-pipeline="builtin.module(canonicalize, placement-sc{strategy=identity arch=IBMFalcon}, route-sc{method=astar arch=IBMFalcon},verify-routing-sc{arch=IBMFalcon})" -verify-diagnostics | FileCheck %s

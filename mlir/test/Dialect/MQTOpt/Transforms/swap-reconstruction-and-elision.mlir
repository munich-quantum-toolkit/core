...
// -----
// This test checks that two consecutive CNOT gates with swapped target and control are merged and elided correctly.
...
// -----
// This test checks that controlled CNOT gates with differing controls (positive and negative) are not merged.
...
module {
  ...
  func.func @testNoControlledSwapReconstruction() {
    ...
    // CHECK: %[[Q0_3:.*]], %[[Q12_3:.*]]:2, %[[Q3_3:.*]] = mqtopt.x() %[[Q0_2]] ctrl %[[Q1_2]]
    ...
    %q0_3, %q1_3, %q2_2, %q3_3 = mqtopt.x() %q0_2 ctrl %q1_2: !mqtopt.Qubit ctrl !mqtopt.Qubit, !mqtopt.Qubit nctrl !mqtopt.Qubit

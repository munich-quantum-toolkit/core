...
/// Verify the operations and SSA captures in a QC modifier body.
[[nodiscard]] LogicalResult verifyModifierBody(Operation* modifierOp,
                                               Block& body);

/// Return the positions of modifier qubits used by @p body.
...
///
/// The block arguments of unused qubits have no uses, so they are
